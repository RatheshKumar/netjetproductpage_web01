...
import { Check, ArrowRight, ChevronDown, Shield } from 'lucide-react';
    ...
    <div ref={scrollRef}>
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch stagger-1">
            {pricingData.map((plan) => (
              <div
                key={plan.name}
                className={`relative flex flex-col h-full fade-in-up ${plan.highlight ?
              ...
              >
                ...
                <Link
                  to="/waitlist"
                  className={`w-full py-4 rounded-[12px] font-bold font-display transition-all duration-300 text-center ${plan.highlight ? 'btn-primary shadow-xl' : 'bg-page-bg border border-border-light text-brand-indigo hover:bg-brand-indigo/5'}`}
                >
                  {plan.cta}
                </Link>
              </div>
      ...
      <section className="section-white py-24 border-y border-border-light">
        <div className="max-w-[800px] mx-auto px-6">
          ...
          <div className="bg-white border border-border-light rounded-[18px] overflow-hidden fade-up">
            {[
              {
